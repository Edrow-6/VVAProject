...
@extends('home.layout', ['title' => 'Accueil', 'page_type' => 'home', 'body_classes' => 'bg-gray-100'])
              ...
              <div class="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
                ...
                <div class="mt-10 max-w-sm mx-auto sm:max-w-none sm:flex sm:justify-center">
                  <div class="space-y-4 sm:space-y-0 sm:mx-auto sm:inline-grid sm:grid-cols-1 sm:gap-5">
                    <a href="/lodging" class="flex transform hover:-translate-y-0.5 duration-150 items-center justify-center px-4 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-blue-200 hover:text-white bg-blue-500 bg-opacity-50 backdrop-filter backdrop-blur-md hover:bg-opacity-70 sm:px-8">
