  ...
  <div class="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8">
    <div class="flex justify-between h-16">
      ...
      <div class="hidden lg:ml-4 lg:flex lg:items-center">
        <button class="flex-shrink-0 bg-transparent p-1 text-gray-400 rounded-md transition duration-75 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500">
  ...
  <div class="lg:hidden" id="mobile-menu">
    ...
    <div class="pt-4 pb-3 border-t border-gray-200">
      ...
      <div class="mt-3 space-y-1">
        <a href="/dash" class="block px-4 py-2 text-base font-medium text-gray-500 hover:text-gray-800 hover:bg-gray-100">Tableau de bord</a>
