...
<header x-data="{ mainMenu: false }" class="shrink-0 relative h-16 bg-blue-900 flex items-center">
  ...
  <div class="absolute inset-y-0 left-0 lg:static lg:shrink-0">
    <a href="#" class="flex items-center justify-center h-16 w-16 bg-blue-800 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-600 lg:w-20">
...
>>>>>>> dev
    ...
    >
      ...
      <div class="max-w-8xl mx-auto py-3 px-2 sm:px-4">
        <a href="/dashboard" class="block rounded-md py-2 px-3 text-base font-medium text-gray-900 hover:bg-gray-100">Statistiques</a>
        <a href="/dashboard/lodgings" class="block rounded-md py-2 pl-5 pr-3 text-base font-medium text-gray-500 hover:bg-gray-100">Hébergements</a>
        <a href="/dashboard/bookings" class="block rounded-md py-2 pl-5 pr-3 text-base font-medium text-gray-500 hover:bg-gray-100">Réservations</a>
        <a href="/dashboard/users" class="block rounded-md py-2 pl-5 pr-3 text-base font-medium text-gray-500 hover:bg-gray-100">Utilisateurs</a>
      </div>
      <div class="border-t border-gray-200 pt-4 pb-3">
        <div class="max-w-8xl mx-auto px-4 flex items-center sm:px-6">
          ...
          <a href="#" class="ml-auto shrink-0 bg-white p-2 text-gray-400 hover:text-gray-500">
        ...
        <div class="mt-3 max-w-8xl mx-auto px-2 space-y-1 sm:px-4">
          ...
          <a href="/account/settings" class="block rounded-md py-2 px-3 text-base font-medium text-gray-900 hover:bg-gray-50">Mon compte</a>

          <a href="/auth/logout" class="block rounded-md py-2 px-3 text-base font-medium text-gray-900 hover:bg-gray-50">Se déconnecter</a>
        </div>
      </div>
    </nav>
  </div>
