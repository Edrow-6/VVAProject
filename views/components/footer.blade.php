<footer class="bg-gray-300 shadow-inner">
  <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
    <div class="flex justify-center space-x-6 md:order-2">
      <a href="https://twitter.com/Edrow__" target="_blank" class="text-twitter transform hover:scale-110 duration-150 hover:text-blue-600">
      ...
      <a href="https://github.com/Edrow-6" target="_blank" class="text-github transform hover:scale-110 duration-150 hover:text-gray-600">
