<nav id="main-navbar" class="sticky top-0 z-10 py-2 duration-200 transition-spacing">
    ...
    <div class="flex justify-between h-16">
      ...
      <div class="hidden lg:ml-4 lg:flex lg:items-center">
        ...
        <div class="relative ml-4 shrink-0">
          <div>
            <button type="button" data-dropdown="user-menu" class="flex items-center text-sm transition duration-75 bg-transparent rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500" aria-expanded="false" aria-haspopup="true">
