    ...
    <div class="flex min-h-screen bg-white">
      <div class="flex flex-col justify-center flex-1 px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
        <div class="w-full max-w-sm mx-auto lg:w-96">
          <div>
            <a href="/">
              <img class="w-auto h-16" src="@asset('logo_teal_dark')" alt="VVA">
            </a>
          ...
          <div class="mt-8">
            <div>
              <div>
                ...
                <div class="grid grid-cols-2 gap-3 mt-1">
                  <div>
                    <a href="/auth/login/api/google" class="inline-flex justify-center hover:shadow duration-150 w-full px-4 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-300 rounded-md shadow-sm hover:bg-gray-50">
                  ...
                  <div>
                    <a href="/auth/login/api/github" class="inline-flex justify-center hover:shadow duration-150 w-full px-4 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-300 rounded-md shadow-sm hover:bg-gray-50">
            ...
            <div class="mt-6">
              <form action="#" method="POST" class="space-y-6">
                ...
                <div x-data="{ show: true }" class="space-y-1">
                  ...
                  <div class="mt-1">
                    <div class="relative">
                      ...
                      <div class="absolute inset-y-0 right-0 pr-3 flex items-center">
                        <button type="button" @click="show = !show" :class="{ 'hidden': !show, 'block': show }" class="transform hover:scale-110 duration-100">
                          <i class="fad fa-eye fa-lg text-green-600"></i>
                        </button>
                        <button type="button" @click="show = !show" :class="{ 'block': !show, 'hidden': show }" class="transform hover:scale-110 duration-100">
                          <i class="fad fa-eye-slash fa-lg text-red-600"></i>
                        </button>
                      </div>
                    </div>
                  </div>
                ...
                <div class="flex items-center justify-between">
                  ...
                  <div class="text-sm">
                    <a href="/login/mdp-oublie" class="font-medium duration-150 border-b-2 border-white hover:border-blue-300 text-blue-600 hover:text-blue-500">
                      Mot de passe oublié ?
                    </a>
                  </div>
                </div>
