            ...
            <div>
              <div>
                ...
                <div class="grid grid-cols-2 gap-3 mt-1">
                  <div>
                    <a href="/auth/connexion/api/google" class="inline-flex justify-center hover:shadow duration-150 w-full px-4 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-300 rounded-md shadow-sm hover:bg-gray-50">
                  ...
                  <div>
                    <a href="/auth/connexion/api/github" class="inline-flex justify-center hover:shadow duration-150 w-full px-4 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-300 rounded-md shadow-sm hover:bg-gray-50">
            ...
            <div class="mt-6">
              <form action="#" method="POST" class="space-y-6">
                ...
                <div class="flex items-center justify-between">
                  ...
                  <div class="text-sm">
                    <a href="/connexion/mdp-oublie" class="font-medium duration-150 border-b-2 border-white hover:border-blue-300 text-blue-600 hover:text-blue-500">
                      Mot de passe oublié ?
                    </a>
                  </div>
                </div>
